...
const ToolsDeliveryDay = dynamic(() => import('@/components/tools/tools-delivery-day').then(m => m.ToolsDeliveryDay))
...
export function ReplyPromptLauncher() {
  ...
  return <>
    ...
    {open && <div id="inbox-reply-prompt" className="basis-full w-full pt-4"><ToolsDeliveryDay /><ToolsCustomerReplyPrompt /></div>}
  </>
}
