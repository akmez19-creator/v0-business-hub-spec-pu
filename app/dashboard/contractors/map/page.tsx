...
export default async function ContractorMapPage() {
  ...
  if (riderIds.length > 0) {
    ...
    const { data: todayData } = await supabase
      .from('deliveries')
      .select('id, customer_name, contact_1, locality, products, qty, amount, status, rider_id, latitude, longitude, delivery_notes, client_response, delivery_date, location_flagged, client_lat, client_lng, location_source, sales_type, return_product, is_modified, modification_count, delivered_at, pending_modification_id')
