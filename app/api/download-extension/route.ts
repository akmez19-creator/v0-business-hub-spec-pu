...
<div class="header">
    <div class="header-logo">
      ...
      <div class="header-text">
        <div class="header-title">Quick Order v3.0</div>
...
let currentTab='orders';
document.querySelectorAll('.akmez-tab').forEach(tab=>{tab.addEventListener('click',()=>{document.querySelectorAll('.akmez-tab').forEach(t=>t.classList.remove('active'));tab.classList.add('active');currentTab=tab.dataset.tab;if(currentTab==='orders')loadData();else renderWorktime();});});
function renderWorktime(){const body=document.getElementById('akmez-body');body.innerHTML='<div style="text-align:center;padding:30px;"><div style="font-size:36px;font-weight:700;margin-bottom:10px;">00:00:00</div><div style="color:#888;font-size:12px;margin-bottom:20px;">Working Time Tracker</div><div style="display:flex;gap:8px;justify-content:center;margin-bottom:20px;"><input type="password" maxlength="1" style="width:40px;height:50px;text-align:center;font-size:20px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:white;"><input type="password" maxlength="1" style="width:40px;height:50px;text-align:center;font-size:20px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:white;"><input type="password" maxlength="1" style="width:40px;height:50px;text-align:center;font-size:20px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:white;"><input type="password" maxlength="1" style="width:40px;height:50px;text-align:center;font-size:20px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:white;"></div><button style="width:100%;padding:12px;background:linear-gradient(135deg,#10b981,#059669);border:none;border-radius:8px;color:white;font-weight:600;cursor:pointer;">Clock In</button></div>';}
