                    ...
                    onClick={() => { 
                      if (replaceMode) {
                        ...
                        if (bestSource) {
                          ...
                          // Default to current order's price when swapping (user can change if needed)
                          const currentOrderPrice = currentItems[0]?.unitPrice || 0
                          setReplacePrice(String(currentOrderPrice))
